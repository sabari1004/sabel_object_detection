...
class OverviewDeepLab extends StatelessWidget {
  Size deviceSize;
  ...
  Widget build(BuildContext context) {
    ...
    return CommonScaffold(
      appTitle: "Overview - DeepLab Model",
      bodyData: bodyData(),
      elevation: 0.0,
    );
  }
          ...
          FittedBox(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Hyperlink('https://arxiv.org/pdf/1704.04861.pdf', 'https://arxiv.org/pdf/1704.04861.pdf'),
                SizedBox(
                  height: 10.0,
                ),
                ProfileTile(
